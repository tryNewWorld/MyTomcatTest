...
public class FruitDaoImpl extends BaseDao<Fruit> implements FruitDao {
    ...
    public List<Fruit> queryFruit(String keyWord, Integer pageNo, Integer pageSize) {
        String key = "%" + keyWord + "%";
        StringBuffer sb = new StringBuffer("select id, name, price, count, remark from fruit where name like ? or remark like ? limit ?, ?");
        return this.executeQuery(sb.toString(), key, key, (pageNo-1)*pageSize, pageSize);
    }
